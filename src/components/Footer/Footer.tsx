  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography sx={{ color: "#fff" }}>Lorem ipsum</Typography>
          ...
          <NavLink to="/about">
            <Button disableElevation sx={{ color: "#Red" }}>
              read more
            </Button>
          </NavLink>
          <Box component="form">
          ...
          <Box sx={{ border: "1px solid #fff", px: 3, py: 2 }}>
            <address>
              ...
              <Link
                ...
                href="mailto:adilsultanbaev43@gmail.com"
              >
                adilsultanbaev43@gmail.com
              </Link>
              <br />
              <Typography sx={{ color: "#00bfff" }}>Nairobi Kenya</Typography>
            </address>
          </Box>
        </Box>
      ...
      >
        ...
        >
          <Typography>
            ...
            <NavLink to="privacy-policy" style={{ color: "#c1c1c1" }}>
              Privacy Policy
            </NavLink>
          </Typography>
          <Divider
